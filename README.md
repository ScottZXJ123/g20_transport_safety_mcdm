...
- **AROMAN** (Alternative Ranking Order Method Accounting for two-step Normalization; [Boskovic et al., 2023](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10097712)) for multi-criteria aggregation
...
| AROMAN scoring | [Boskovic et al. (2023)](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10097712) |
